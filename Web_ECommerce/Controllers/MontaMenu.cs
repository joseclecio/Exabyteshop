...
namespace Exabyteshop.Controllers
{
    public class MontaMenu : BaseController
    {
        ...
        public MontaMenu(UserManager<Usuario> userManager, ILogger<ProdutosController> logger, InterfaceLogSistemaApp InterfaceLogSistemaApp, InterfaceMontaMenu InterfaceMontaMenu)
